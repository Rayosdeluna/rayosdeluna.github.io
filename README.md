...
<body>
 ...
 <!-- INICIO -->
  <section id="inicio" class="hero">
    ...
    <div class="card">
      <img alt="Bisitería Rayos de Luna" <img src="https://i.ibb.co/27MR6yxh/El-texto-del-p-rrafo-1.png" alt="El-texto-del-p-rrafo-1" border="0"></a>
    </div>
  </section>
  ...
  <section id="productos">
    ...
    <div class="grid cols-3">
      <article class="card product" data-sku="combo-estrella">
       <img src="https://i.ibb.co/bgqCwhDs/combo-estrella.png" alt="combo-estrella" width="120" style="border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.2);"> </a>
